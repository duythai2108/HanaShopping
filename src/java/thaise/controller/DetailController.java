    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String url = ERROR;
        try {
            ...
            int catgID = Integer.valueOf(request.getParameter("txtCatgID"));
            ProductDAO dao = new ProductDAO();
            ProductDTO dto = dao.getListProductID(productID);
             List<ProductDTO> list = dao.getListProductRec(catgID);
